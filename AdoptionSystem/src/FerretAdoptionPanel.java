...
public class FerretAdoptionPanel extends AbstractAnimalAdoptionPanel {
    private JButton robertButton;
    private JButton bridgetButton;
    private JButton biscuitButton;
    private JButton backButton;
    private Set<String> addedPetIds = new HashSet<>();

    public FerretAdoptionPanel(JPanel mainPanel, CardLayout cardLayout) {
        super(mainPanel, cardLayout, "Ferret");
    ...
    protected void initializeComponents() {
        ...
        headerLabel = new JLabel("Available Ferrets for Adoption");  
        ...
        robertButton = createButtonWithListener("See More", e -> RobertDetails()); 
        bridgetButton = createButtonWithListener("See More", e -> BridgetDetails()); 
        biscuitButton = createButtonWithListener("See More", e -> BiscuitDetails());
    ...
    protected void setupListeners() {
        robertButton.addActionListener(e -> RobertDetails()); 
        bridgetButton.addActionListener(e -> BridgetDetails()); 
        biscuitButton.addActionListener(e -> BiscuitDetails()); 
    }
    ...
    private void loadDatabasePets() { 
        try (Connection conn = DatabaseConnection.getConnection()) { 
            ...
            try (PreparedStatement stmt = conn.prepareStatement(query)) { 
                stmt.setString(1, "Ferret"); 
                try (ResultSet rs = stmt.executeQuery()) { 
                    while (rs.next()) { 
                        String petId = rs.getString("pet_id"); 
                         
                        if (addedPetIds.contains(petId)) { 
                            System.out.println("Skipping duplicate pet: " + petId); 
                            continue; 
                        } 
    ...
    private void showDatabasePetDetails(String petId, String name, String age, String sex, String breed, String imagePath) {   
        ...
        // Back button 
        JButton backButton = new JButton("Back to Ferrets"); 
        backButton.setPreferredSize(new Dimension(150, 40)); 
        backButton.addActionListener(e -> switchPanel("ferretAdoptionPanel")); 
    ...
    private void RobertDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Robert");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\ferret-robert.jpg");
    ...
    createPetDetailsPanel("2023-0017", "Robert", detailsPanel, infoPanel); 
    ...
    contentPanel.add(infoPanel, gbc); 
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "robertDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "FerretDetails");
            cardLayout.show(mainPanel, "FerretDetails");
    }

    private void BridgetDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Bridget");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        // Add image (make it slightly smaller to give more room for description)
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\ferret-bridget.jpg");
        Image scaledImage = icon.getImage().getScaledInstance(550, 550, Image.SCALE_SMOOTH);  // Reduced size
        JLabel imageLabel = new JLabel(new ImageIcon(scaledImage));
        gbc.gridx = 0;
        gbc.gridy = 0;
        ...
        // Add all details from database 
        createPetDetailsPanel("2023-0018", "Bridget", detailsPanel, infoPanel); 
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "bridgetDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "BridgetDetails");
            cardLayout.show(mainPanel, "BridgetDetails");
    }

    private void BiscuitDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Biscuit");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        // Add image (make it slightly smaller to give more room for description)
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\ferret-biscuit.jpg");
        Image scaledImage = icon.getImage().getScaledInstance(550, 550, Image.SCALE_SMOOTH);  // Reduced size
        JLabel imageLabel = new JLabel(new ImageIcon(scaledImage));
        gbc.gridx = 0;
        gbc.gridy = 0;
    ...
    // Add all details from database 
    createPetDetailsPanel("2023-0019", "Biscuit", detailsPanel, infoPanel); 
    ...
    contentPanel.add(infoPanel, gbc); 
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "biscuitDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "BiscuitDetails");
            cardLayout.show(mainPanel, "BiscuitDetails");
    }
