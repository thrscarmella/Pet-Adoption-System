...
public class TurtleAdoptionPanel extends AbstractAnimalAdoptionPanel {
    private JButton tacoButton;
    private JButton taquitoButton;
    private JButton backButton;
    private Set<String> addedPetIds = new HashSet<>();

    public TurtleAdoptionPanel(JPanel mainPanel, CardLayout cardLayout) {
        super(mainPanel, cardLayout, "Turtle");
    ...
    protected void initializeComponents() {
        ...
        headerLabel = new JLabel("Available Turtles for Adoption");  
        ...
        tacoButton = createButtonWithListener("See More", e -> TacoDetails());
        taquitoButton = createButtonWithListener("See More", e -> TaquitoDetails());
    }
    ...
    */
    ...
    private void refreshPetDisplay() {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) { 
            String query = "SELECT COUNT(*) FROM pets WHERE type = 'Turtle' AND status = 'available'"; 
    ...
    protected void setupListeners() {
        tacoButton.addActionListener(e -> TacoDetails());
        taquitoButton.addActionListener(e -> TaquitoDetails());
    }
    ...
    private void showDatabasePetDetails(String petId, String name, String age, String sex, String breed, String imagePath) { 
        ...
        // Back button 
        JButton backButton = new JButton("Back to Turtles"); 
        backButton.setPreferredSize(new Dimension(150, 40)); 
        backButton.addActionListener(e -> switchPanel("turtleAdoptionPanel")); 
    ...
    private void TacoDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Taco");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\turtle-taco.png");
    ...
    createPetDetailsPanel("2023-0040", "Taco", detailsPanel, infoPanel); 
    ...
    contentPanel.add(infoPanel, gbc);
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "tacoDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "TacoDetails");
            cardLayout.show(mainPanel, "TacoDetails");
    }

    private void TaquitoDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Taquito");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        // Add image (make it slightly smaller to give more room for description)
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\turtle-taquito.png");
        Image scaledImage = icon.getImage().getScaledInstance(550, 550, Image.SCALE_SMOOTH);  // Reduced size
        JLabel imageLabel = new JLabel(new ImageIcon(scaledImage));
        gbc.gridx = 0;
        gbc.gridy = 0;
    ...
    // Add all details from database 
    createPetDetailsPanel("2023-0041", "Taquito", detailsPanel, infoPanel); 
    ...
    contentPanel.add(infoPanel, gbc);
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "taquitoDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "TaquitoDetails");
            cardLayout.show(mainPanel, "TaquitoDetails");
    }
