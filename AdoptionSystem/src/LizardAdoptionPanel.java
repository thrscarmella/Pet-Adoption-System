...
public class LizardAdoptionPanel extends AbstractAnimalAdoptionPanel {
    private JButton liloButton;
    private JButton backButton;
    private Set<String> addedPetIds = new HashSet<>();

    public LizardAdoptionPanel(JPanel mainPanel, CardLayout cardLayout) {
        super(mainPanel, cardLayout, "Lizard");
    ...
    protected void initializeComponents() {
        ...
        headerLabel = new JLabel("Available Lizards for Adoption");  
        ...
        liloButton = createButtonWithListener("See More", e -> LiloDetails());
...
/*
    ...
    protected void setupListeners() {
        liloButton.addActionListener(e -> LiloDetails());
    }
    ...
    private void showDatabasePetDetails(String petId, String name, String age, String sex, String breed, String imagePath) { 
        ...
        // Back button 
        JButton backButton = new JButton("Back to Lizards"); 
        backButton.setPreferredSize(new Dimension(150, 40)); 
        backButton.addActionListener(e -> switchPanel("lizardAdoptionPanel")); 
    ...
    private void LiloDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Lilo");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        detailsPanel.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));
        detailsPanel.setBackground(new Color(248, 236, 197)); 
    
        JPanel contentPanel = new JPanel(new GridBagLayout());
        contentPanel.setBorder(BorderFactory.createEmptyBorder(0, 40, 0, 40));
        contentPanel.setBackground(new Color(248, 236, 197)); 
        GridBagConstraints gbc = new GridBagConstraints();
        gbc.insets = new Insets(5, 30, 5, 5);

        // Add image (make it slightly smaller to give more room for description)
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\lizard-lilo.png");
        ...
        infoPanel.setLayout(new BoxLayout(infoPanel, BoxLayout.Y_AXIS)); 
        infoPanel.setBorder(BorderFactory.createEmptyBorder(0, 40, 0, 20));
        infoPanel.setBackground(new Color(248, 236, 197));  
 
    // Add all details from database 
    createPetDetailsPanel("2023-0031", "Lilo", detailsPanel, infoPanel);
    // Add info panel to content panel 
    gbc.gridx = 1; 
    gbc.gridy = 0; 
    gbc.weightx = 1.0; 
    ...
    contentPanel.add(infoPanel, gbc);
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "liloDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "LiloDetails");
            cardLayout.show(mainPanel, "LiloDetails");
    }
