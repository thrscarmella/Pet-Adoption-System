...
public class HamsterAdoptionPanel extends AbstractAnimalAdoptionPanel {
    private JButton autumnButton;
    private JButton chachaButton;
    private JButton jackjillButton;
    private JButton oshinneButton;
    private JButton sausageButton;
    private JButton timmyButton;
    private JButton backButton;
    private Set<String> addedPetIds = new HashSet<>();

    public HamsterAdoptionPanel(JPanel mainPanel, CardLayout cardLayout) {
        super(mainPanel, cardLayout, "Hamster");
    ...
    protected void initializeComponents() {
        ...
        headerLabel = new JLabel("Available Hamsters for Adoption");  
        ...
        autumnButton = createButtonWithListener("See More", e -> AutumnDetails()); 
        chachaButton = createButtonWithListener("See More", e -> ChachaDetails());
        jackjillButton = createButtonWithListener("See More", e -> JackjillDetails()); 
        oshinneButton = createButtonWithListener("See More", e -> OshinneDetails()); 
        sausageButton = createButtonWithListener("See More", e -> SausageDetails());
        timmyButton = createButtonWithListener("See More", e -> TimmyDetails());
    ...
    private void refreshPetDisplay() {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) { 
            String query = "SELECT COUNT(*) FROM pets WHERE type = 'Hamster' AND status = 'available'"; 
    ...
    protected void setupListeners() {
        autumnButton.addActionListener(e -> AutumnDetails()); 
        chachaButton.addActionListener(e -> ChachaDetails()); 
        jackjillButton.addActionListener(e -> JackjillDetails());
        oshinneButton.addActionListener(e -> OshinneDetails()); 
        sausageButton.addActionListener(e -> SausageDetails());
        timmyButton.addActionListener(e -> TimmyDetails());  
    }
    ...
    private void showDatabasePetDetails(String petId, String name, String age, String sex, String breed, String imagePath) { 
        ...
        // Back button 
        JButton backButton = new JButton("Back to Hamsters"); 
        backButton.setPreferredSize(new Dimension(150, 40)); 
        backButton.addActionListener(e -> switchPanel("hamsterAdoptionPanel")); 
    ...
    private void AutumnDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Autumn");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\hamster-autumn.jpg");
    ...
    createPetDetailsPanel("2023-0025", "Autumn", detailsPanel, infoPanel); 
    ...
    contentPanel.add(infoPanel, gbc);
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "autumnDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "AutumnDetails");
            cardLayout.show(mainPanel, "AutumnDetails");
    }

    private void ChachaDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Chacha");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        // Add image (make it slightly smaller to give more room for description)
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\hamster-chacha.jpg");
        Image scaledImage = icon.getImage().getScaledInstance(550, 550, Image.SCALE_SMOOTH);  // Reduced size
        JLabel imageLabel = new JLabel(new ImageIcon(scaledImage));
        gbc.gridx = 0;
        gbc.gridy = 0;
    ...
    // Add all details from database 
    createPetDetailsPanel("2023-0026", "Chacha", detailsPanel, infoPanel); 
    ...
    contentPanel.add(infoPanel, gbc);
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "chachaDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "ChachaDetails");
            cardLayout.show(mainPanel, "ChachaDetails");
    }

    private void JackjillDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Jack & Jill");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        // Add image (make it slightly smaller to give more room for description)
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\hamster-jack-jill.jpg");
        Image scaledImage = icon.getImage().getScaledInstance(550, 550, Image.SCALE_SMOOTH);  // Reduced size
        JLabel imageLabel = new JLabel(new ImageIcon(scaledImage));
        gbc.gridx = 0;
        gbc.gridy = 0;
    ...
    // Add all details from database 
    createPetDetailsPanel("2023-0027", "Jack & Jill", detailsPanel, infoPanel); 
    ...
    contentPanel.add(infoPanel, gbc);
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "jackjillDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "JackjillDetails");
            cardLayout.show(mainPanel, "JackjillDetails");
    }

    private void OshinneDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Oshinne");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        // Add image (make it slightly smaller to give more room for description)
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\hamster-oshinne.jpg");
        Image scaledImage = icon.getImage().getScaledInstance(550, 550, Image.SCALE_SMOOTH);  // Reduced size
        JLabel imageLabel = new JLabel(new ImageIcon(scaledImage));
        gbc.gridx = 0;
        gbc.gridy = 0;
    ...
    // Add all details from database 
    createPetDetailsPanel("2023-0028", "Oshinne", detailsPanel, infoPanel); 
    ...
    contentPanel.add(infoPanel, gbc);
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "oshinneDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "OshinneDetails");
            cardLayout.show(mainPanel, "OshinneDetails");
    }

    private void SausageDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Sausage");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        // Add image (make it slightly smaller to give more room for description)
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\hamster-sausage.jpg");
        Image scaledImage = icon.getImage().getScaledInstance(550, 550, Image.SCALE_SMOOTH);  // Reduced size
        JLabel imageLabel = new JLabel(new ImageIcon(scaledImage));
        gbc.gridx = 0;
        gbc.gridy = 0;
    ...
    // Add all details from database 
    createPetDetailsPanel("2023-0029", "Sausage", detailsPanel, infoPanel); 
    ...
    contentPanel.add(infoPanel, gbc);
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "sausageDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "SausageDetails");
            cardLayout.show(mainPanel, "SausageDetails");
    }

    private void TimmyDetails() {
        // Create a new panel for details
        JPanel detailsPanel = new JPanel();
        headerLabel = new JLabel("More Details About Timmy");
        headerLabel.setFont(new Font("Helvetica", Font.BOLD, 40));
        headerLabel.setHorizontalAlignment(SwingConstants.CENTER);
        headerLabel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0));
        detailsPanel.setLayout(new BorderLayout(20, 20));
        ...
        // Add image (make it slightly smaller to give more room for description)
        ImageIcon icon = new ImageIcon("C:\\Users\\mcdeu\\Documents\\object\\hamster-timmy.jpg");
        Image scaledImage = icon.getImage().getScaledInstance(550, 550, Image.SCALE_SMOOTH);  // Reduced size
        JLabel imageLabel = new JLabel(new ImageIcon(scaledImage));
        gbc.gridx = 0;
        gbc.gridy = 0;
    ...
    // Add all details from database 
    createPetDetailsPanel("2023-0030", "Timmy", detailsPanel, infoPanel); 
    ...
    contentPanel.add(infoPanel, gbc);
        ...
        adoptButton.setFont(new Font("Arial", Font.BOLD, 16));
        adoptButton.addActionListener(e -> {
            String currentPanel = "timmyDetails";
            AdoptionFormPanel adoptionForm = new AdoptionFormPanel(mainPanel, cardLayout, currentPanel);
            mainPanel.add(adoptionForm, "adoptionFormPanel");
            cardLayout.show(mainPanel, "adoptionFormPanel");
        });
            ...
            // Add the details panel to the main panel and show it
            mainPanel.add(detailsPanel, "TimmyDetails");
            cardLayout.show(mainPanel, "TimmyDetails");
    }
